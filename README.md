### О проекте
Веб-приложение для интерактивной работы с 3D-картами. Разработано для [название хакатона/события] с целью облегчить визуализацию географических данных. Приложение поддерживает поиск, навигацию и наложение слоев информации.
